...
public class Ex13 {
    ...
    public void testUserAgent(String userAgent, String platform, String browser, String device) {
        ...
        assertEquals(platform, response.getString("platform"), "Response doesn't contain platform");
        assertEquals(browser, response.getString("browser"), "Response doesn't contain browser");
        assertEquals(device, response.getString("device"), "Response doesn't contain device");
    }
}
